...
std::string NativeAdsClient::GetUserModelPath(const std::string & model_id) {
  return [bridge_ getUserModelPath:model_id];
}
...
std::string NativeAdsClient::GetPath() {
  return [bridge_ getPath];
}
