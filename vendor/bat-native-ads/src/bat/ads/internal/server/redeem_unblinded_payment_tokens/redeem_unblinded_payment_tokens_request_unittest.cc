...
#include "bat/ads/internal/redeem_unblinded_payment_tokens_request.h"
...
#include "bat/ads/internal/confirmations_client_mock.h"
#include "bat/ads/internal/confirmations_impl.h"
#include "bat/ads/internal/unblinded_tokens.h"
...
class BatAdsRedeemUnblindedPaymentTokensRequestTest
    : public ::testing::Test {
 protected:
  BatAdsRedeemUnblindedPaymentTokensRequestTest()
  ...
  ~BatAdsRedeemUnblindedPaymentTokensRequestTest() override {
...
TEST_F(BatAdsRedeemUnblindedPaymentTokensRequestTest,
    BuildUrl) {
  // Arrange
  WalletInfo wallet;
