...
#include "bat/ads/internal/create_confirmation_request.h"
...
#include "bat/ads/internal/platform_helper.h"
...
class BatAdsCreateConfirmationRequestTest : public ::testing::Test {
 protected:
  BatAdsCreateConfirmationRequestTest()
  ...
  ~BatAdsCreateConfirmationRequestTest() override {
...
TEST_F(BatAdsCreateConfirmationRequestTest,
    BuildUrl) {
  // Arrange
