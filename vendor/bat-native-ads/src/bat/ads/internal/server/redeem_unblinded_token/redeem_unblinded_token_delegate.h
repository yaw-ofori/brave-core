...
#ifndef BAT_ADS_INTERNAL_REDEEM_UNBLINDED_TOKEN_DELEGATE_H_
#define BAT_ADS_INTERNAL_REDEEM_UNBLINDED_TOKEN_DELEGATE_H_
...
#endif  // BAT_ADS_INTERNAL_REDEEM_UNBLINDED_TOKEN_DELEGATE_H_
