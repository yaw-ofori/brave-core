...
#ifndef BAT_ADS_INTERNAL_REFILL_UNBLINDED_TOKENS_DELEGATE_H_
#define BAT_ADS_INTERNAL_REFILL_UNBLINDED_TOKENS_DELEGATE_H_
...
#endif  // BAT_ADS_INTERNAL_REFILL_UNBLINDED_TOKENS_DELEGATE_H_
