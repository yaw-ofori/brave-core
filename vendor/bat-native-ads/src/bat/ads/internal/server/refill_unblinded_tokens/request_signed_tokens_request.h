...
#ifndef BAT_ADS_INTERNAL_REQUEST_SIGNED_TOKENS_REQUEST_H_
#define BAT_ADS_INTERNAL_REQUEST_SIGNED_TOKENS_REQUEST_H_
...
#endif  // BAT_ADS_INTERNAL_REQUEST_SIGNED_TOKENS_REQUEST_H_
