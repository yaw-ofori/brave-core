...
#ifndef BAT_ADS_INTERNAL_CLIENT_STATE_CLIENT_STATE_H_
#define BAT_ADS_INTERNAL_CLIENT_STATE_CLIENT_STATE_H_
...
#include "bat/ads/internal/client_state/preferences/ad_preferences.h"
