        ...
        >
          <StyledHeader>
            ...
            <StyledCurve background={gradientTop} />
            {
              ...
              ? <LoginMessage>
                  <LoginMessageText>
                    <b>Verifying wallet allows you to manage your funds more efficiently</b>
                    <p>
                      You need to have minimum 25 BAT to create an Uphold account. Please try again later. <br/>
